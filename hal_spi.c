...
void halSpiInit(void)
{
    ...
    // Configure MOSI on pin P2.6
    GPIO_setAsPeripheralModuleFunctionOutputPin(GPIO_PORT_P2, GPIO_PIN6, GPIO_PRIMARY_MODULE_FUNCTION);
    // Configure MISO on pin P2.5
...
uint8_t halSpiWrite(uint8_t addr, const uint8_t* data, uint8_t length)
{
    ...
    GPIO_setOutputLowOnPin(GPIO_PORT_P1, GPIO_PIN7); // set CSN low
    ...
    GPIO_setOutputHighOnPin(GPIO_PORT_P1, GPIO_PIN7); // set CSN high
    return(0);
